...
def parse_args() -> TrainConfig:
    ...
    p.add_argument("--wl_weight",    type=float, default=0.00,  help="Wirelength reward weight")
    p.add_argument("--pw_weight",    type=float, default=0.34,  help="Power reward weight")
    p.add_argument("--dl_weight",    type=float, default=0.33,  help="Delay reward weight")
    p.add_argument("--ar_weight",    type=float, default=0.33,  help="Routing-area reward weight")
