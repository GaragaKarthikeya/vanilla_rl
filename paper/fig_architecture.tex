...
\node[lbl, align=left, anchor=south west] (pool_lbl)
      at ($(emb_pool.north west) + (0, 0.5mm)$) {mean-pooled\\[-0.3ex]whole-netlist\\[-0.3ex]\small 64-d};
...
\node[lbl, align=left, anchor=north west] (curr_lbl)
      at ($(emb_curr.south west) + (0, -0.5mm)$) {current\\[-0.3ex]H-block\\[-0.3ex]\small 64-d};
...
\node[lbl, align=left, anchor=north west] (cnn_lbl)
      at ($(emb_cnn.south west) + (0, -0.5mm)$) {CNN output\\[-0.3ex]\small 64-d};
...
\node[lbl, align=left, anchor=north west] (wh_lbl)
      at ($(emb_wh.south west) + (0, -0.5mm)$) {\small 2-d};
...
% LEGEND
% =========================================================
\node[legendkey, fill=pTERRA!12, draw=pTERRA] (lg1) at ($(current bounding box.south)+(-138mm,-16mm)$) {};
